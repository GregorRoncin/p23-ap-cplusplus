...
class Edge {
    // vr: ne pas mettre les attributs en public les mettre en private et utiliser friend
    friend class Vertex;
    friend class Graph;
    // public: // vr: mnon
    private:
...
public:
    ...
    // vr: je déclare la méthode print et je la définis plus loin quand la class Vertex est définie
    // puisque print va accéder à des attributs de Vertex il faut qu'il connaisse la class Vertex
    void print();
};
...
void Edge::print() {
    std::cout<<start->value<<" vers "<<end->value<<" de poids "<<weight<<std::endl;
}
class Graph{
    // vr: ne pas mettre les attributs en public les mettre en private et utiliser friend (par exemple)
    // public : // vr: non
    private:
    std::vector<Vertex*> vertices; // Liste des sommets du graphe
    std::vector<Edge*> edges; // Liste des arêtes du graphe 
    public:
    // vr: tu as choisi l'allocation dynamique new/delete, il faut traiter les problèmes de copie et d'affectation:
    // par exemple les interdire:
    Graph& operator=(const Graph& g) = delete; // on interdit l'opérateur d'affectation
    Graph(const Graph& g) = delete; // on interdit l'utilistion du constructeur de copie
...
int main(){ // on crée très basiquement un graphe
    ...
    // vr: mettre une fonction print dans la classe graph
    myGraph.print();
    // std::cout<<"Représentation du graphe"<<std::endl; // Représentation du graphe, pas très esthétique mais pratique 
    // std::cout<<"les sommets sont"<<std::endl;
